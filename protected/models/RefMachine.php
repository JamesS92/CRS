...
/**
 * This is the model class for table "ref_machine".
 *
 * The followings are the available columns in table 'ref_machine':
 * @property string $id
...
class RefMachine extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'slots' => array(self::HAS_MANY, 'Slot', 'machine_id'),
		);
	}
	 ...
	 * @return RefMachine the static model class
	 */
